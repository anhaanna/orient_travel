            ...
            <div id="middle-content">
                ...
                <div class="container">
                    ...
                    <div id="boxes">
                        ...
                        <div class="box box4">
                            <h2><span class="icon"></span><?php echo app('translator')->getFromJson('home.box4_h2'); ?></h2>
                            <p id="wave">〰〰〰〰〰〰〰</p>
                            <p><?php echo app('translator')->getFromJson('home.box4_p'); ?></p>
                        </div>
                    </div>
    ...
    <?php echo $__env->make('layouts.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <!-- dest -->
                <div id="destinations">
                    <h2><?php echo app('translator')->getFromJson('home.destinations'); ?></h2>

<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['url' => 'contact/submit']); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::text('email', '', ['class'=>'form-control', 'placeholder'=>'Enter Your E-Mail'])); ?>

        </div>
        <div class="form-group">
            <?php echo e(Form::label('message', 'Message')); ?>

            <?php echo e(Form::textarea('message', '', ['class'=>'form-control', 'placeholder'=>'Enter Your Message'])); ?>

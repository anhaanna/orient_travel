...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <title>Armenia | Orient Travel</title>
    ...
    <body>
        ...
        <div id="middle-content">
            ...
            <div id="about-country">
                ...
                <h1><?php echo app('translator')->getFromJson('home.armenia_h1'); ?></h1>
                <p><?php echo app('translator')->getFromJson('home.armenia_about'); ?></p>
            </div>
